...
// at runtime as a command line argument. Type openebs-exporter -h for more
// info.

// StartExporter starts an HTTP server that exposes the metrics on
...
func (options *VolumeExporterOptions) StartExporter() error {
