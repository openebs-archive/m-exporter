...
import (
	...
	zpool "github.com/openebs/exporter/pkg/collector/pool"
	types "github.com/openebs/exporter/pkg/exec"
	mock "github.com/openebs/exporter/pkg/exec/mock"
	mockServer "github.com/openebs/exporter/pkg/util"
)
...
func TestPoolSyncTimeMetricCollector(t *testing.T) {
	cases := map[string]struct {
		...
		"Test5": {
			// if expected output from zfs binary is empty
			zpoolLastSyncTimeOutput: string(NoDataSetAvailable),
			expectedOutput: []string{
